    ...
    return (
      <div className="h-96 flex items-center justify-center bg-gray-100 rounded-lg border-2 border-dashed border-gray-300">
        <div className="text-center px-6">
          ...
          <p className="text-yellow-700 font-bold text-lg mb-2">Normal List Disabled</p>
          <p className="text-gray-500 text-sm">Enable to see the performance difference</p>
  ...
  return (
    <div>
      {renderTime && (
        <div className="mb-4 p-4 bg-red-100 rounded-lg border border-red-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-red-700 font-bold">~{renderTime}ms render time</span>
              <div className="flex items-center gap-2 text-red-600 text-sm mt-0.5">
                <Database className="w-3 h-3" />
                <span>All {items.length.toLocaleString()} DOM nodes created!</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="h-96 overflow-y-auto border border-gray-200 rounded-lg">
        {items.map((item) => (
          <div key={item.id} className="flex items-center gap-3 p-3 border-b border-gray-100 hover:bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="bg-linear-to-r from-cyan-50 to-blue-50 border border-cyan-200 rounded-xl p-6 mb-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-3">What is Virtualization?</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                Virtualization (or "windowing") only renders items that are visible in the viewport. 
                Instead of creating 10,000 DOM nodes, it creates ~15 and reuses them as you scroll.
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="bg-white p-4 rounded-lg text-center border border-green-200">
                  ...
                  <p className="text-sm text-gray-600">DOM nodes (virtualized)</p>
                </div>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
          <div className="bg-indigo-500 px-6 py-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-lg font-bold text-white">How Virtualization Works</h3>
            </div>
          </div>
          <div className="p-6">
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <h4 className="font-bold text-gray-800 mb-1">1. Detect Viewport</h4>
                <p className="text-sm text-gray-600">Calculate which items are visible in the scroll container</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 rounded-full bg-indigo-100 flex items-center justify-center mx-auto mb-3">
                  <Layers className="w-6 h-6 text-indigo-600" />
                </div>
                <h4 className="font-bold text-gray-800 mb-1">2. Render Visible</h4>
                <p className="text-sm text-gray-600">Only create DOM nodes for visible items + small buffer</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 rounded-full bg-indigo-100 flex items-center justify-center mx-auto mb-3">
                  <Activity className="w-6 h-6 text-indigo-600" />
                </div>
                <h4 className="font-bold text-gray-800 mb-1">3. Track Scroll</h4>
                <p className="text-sm text-gray-600">Listen for scroll events and recalculate visible range</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 rounded-full bg-indigo-100 flex items-center justify-center mx-auto mb-3">
                ...
                <p className="text-sm text-gray-600">Update existing elements with new data as user scrolls</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="p-6">
            <div className="flex flex-wrap items-center gap-6">
              ...
              <div className="flex items-center gap-3 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                />
                <label htmlFor="enableNormal" className="text-sm font-medium text-gray-700">
              ...
              <div className="ml-auto flex items-center gap-2 text-gray-600">
                ...
                <span className="font-bold text-lg">{items.length.toLocaleString()}</span>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="bg-red-500 px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-bold text-white">Without Virtualization</h3>
              </div>
            </div>
            <div className="p-6">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="bg-green-500 px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-bold text-white">With Virtualization</h3>
              </div>
              <p className="text-green-100 text-sm mt-1">@tanstack/react-virtual</p>
            </div>
            <div className="p-6">
        ...
        <div className="bg-gray-900 rounded-xl overflow-hidden mb-8">
          <div className="bg-gray-800 px-6 py-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-lg font-bold text-white">Implementation Example</h3>
            </div>
          </div>
          <div className="p-6">
      ...
      <div style={{ height: virtualizer.getTotalSize() }}>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="bg-green-500 px-6 py-4">
              <div className="flex items-center gap-3">
                <CheckCircle className="w-6 h-6 text-white" />
                <h3 className="text-lg font-bold text-white">Use Virtualization When:</h3>
              </div>
            </div>
            <div className="p-6">
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">Lists with 100+ items</p>
                    <p className="text-sm text-gray-500">Large datasets that would create many DOM nodes</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">Tables with many rows</p>
                    <p className="text-sm text-gray-500">Data grids, spreadsheet-like interfaces</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">Infinite scroll feeds</p>
                    <p className="text-sm text-gray-500">Social media feeds, product listings</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">Chat message history</p>
                    <p className="text-sm text-gray-500">Long conversation threads</p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="bg-amber-500 px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-bold text-white">Consider Tradeoffs:</h3>
              </div>
            </div>
            <div className="p-6">
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">Added complexity</p>
                    <p className="text-sm text-gray-500">More code to maintain and debug</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">Ctrl+F limitations</p>
                    <p className="text-sm text-gray-500">Browser search won't find off-screen content</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">Accessibility concerns</p>
                    <p className="text-sm text-gray-500">Screen readers may have difficulty</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Variable row heights need extra configuration</p>
                  </div>
                </li>
              </ul>
            </div>
        ...
        <div className="bg-gray-800 text-white rounded-xl p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-xl font-bold">Popular Virtualization Libraries</h3>
          </div>
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-cyan-500/20 rounded-lg p-4 border border-cyan-500/30">
              <h4 className="font-bold text-cyan-300 mb-2">@tanstack/react-virtual</h4>
              <p className="text-gray-300 text-sm mb-2">Headless, hooks-based virtualization. Full control over rendering.</p>
              <span className="text-xs bg-cyan-500/30 px-2 py-1 rounded text-cyan-200">Recommended</span>
            </div>
            <div className="bg-purple-500/20 rounded-lg p-4 border border-purple-500/30">
              <h4 className="font-bold text-purple-300 mb-2">react-window</h4>
              <p className="text-gray-300 text-sm mb-2">Lightweight, component-based solution by bvaughn.</p>
              <span className="text-xs bg-purple-500/30 px-2 py-1 rounded text-purple-200">Popular Choice</span>
            </div>
            <div className="bg-orange-500/20 rounded-lg p-4 border border-orange-500/30">
              <h4 className="font-bold text-orange-300 mb-2">react-virtuoso</h4>
              <p className="text-gray-300 text-sm mb-2">Feature-rich with variable sizes, grouping, and more.</p>
              <span className="text-xs bg-orange-500/30 px-2 py-1 rounded text-orange-200">Full Featured</span>
            </div>
          </div>
        </div>
      </div>
