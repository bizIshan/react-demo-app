    ...
    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
      ...
      <div className="p-6">
        <p className="text-gray-600 mb-4 flex items-center gap-2">
          ...
          Click the button rapidly to see how debounce and throttle handle
          events differently:
        </p>
...
function ScrollThrottleDemo() {
  ...
  const savings =
    rawScrollCount > 0
      ? Math.round((1 - throttledScrollCount / rawScrollCount) * 100)
      : 0;
      ...
      <div className="p-6">
        ...
        >
          {Array.from({ length: 50 }, (_, i) => (
            <div
              key={i}
              className="flex items-center gap-3 p-3 border-b border-orange-100 last:border-0"
            >
        ...
        <div className="mt-4 bg-amber-50 border border-amber-200 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-amber-800">
              Without throttling, scroll events fire{' '}
              <strong>hundreds of times per second</strong>! Throttling ensures
              expensive operations (like calculations or DOM updates) run at
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
          ...
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div className="flex items-center gap-2 text-gray-700">
              ...
              <span className="font-medium">
                Using lodash-es for debounce & throttle
              </span>
            </div>
            <a
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700 mb-4">
                Both techniques limit how often a function executes, but in
                different ways. Understanding when to use each is crucial for
                performance.
              </p>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white p-5 rounded-lg border border-blue-200">
                  ...
                  <p className="text-gray-600 text-sm mb-3">
                    Waits for a <strong>pause</strong> in activity before
                    executing. Like an elevator door that waits until people
                    stop entering.
                  </p>
                  <div className="text-sm bg-blue-50 p-3 rounded-lg">
                    ...
                    <p className="text-gray-600 mt-1">
                      Search inputs, resize handlers, form validation, auto-save
                    </p>
                  </div>
                </div>
                <div className="bg-white p-5 rounded-lg border border-green-200">
                  ...
                  <p className="text-gray-600 text-sm mb-3">
                    Executes at <strong>regular intervals</strong> during
                    activity. Like a metronome that keeps a steady pace.
                  </p>
                  <div className="text-sm bg-green-50 p-3 rounded-lg">
                    ...
                    <p className="text-gray-600 mt-1">
                      Scroll handlers, game loops, rate limiting APIs, tracking
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-8 bg-gray-900 rounded-xl overflow-hidden">
          ...
          <div className="p-6 font-mono text-xs leading-relaxed overflow-x-auto">
            ...
            <p className="mt-4">
              <span className="text-gray-500">{'// useDebounce hook'}</span>
            </p>
            <p>
            ...
            <p className="mt-4">
              <span className="text-gray-500">{'// useThrottle hook'}</span>
            </p>
            <p>
              <span className="text-purple-400">function </span>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-blue-500/20 rounded-lg p-4 border border-blue-500/30">
              ...
              <p className="text-gray-300 text-sm">
                Wait for inactivity. Good for search, resize, validation -
                anything that should run after user finishes.
              </p>
            </div>
            <div className="bg-green-500/20 rounded-lg p-4 border border-green-500/30">
              ...
              <p className="text-gray-300 text-sm">
                Run at steady intervals. Good for scroll, drag, continuous
                events that need regular updates.
              </p>
            </div>
            <div className="bg-orange-500/20 rounded-lg p-4 border border-orange-500/30">
              ...
              <p className="text-gray-300 text-sm">
                Both prevent performance issues by limiting function execution.
