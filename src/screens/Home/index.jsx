...
const demos = [
  {
    ...
    description:
      'Understand how React renders, Virtual DOM, reconciliation, and the render cycle',
    icon: PlayCircle,
  ...
  },
  {
    ...
    description:
      'Why unique keys matter, index key pitfalls, and proper key usage in dynamic lists',
    icon: Key,
  ...
  },
  {
    ...
    description:
      'Master useMemo, useCallback, and memo() - know when to use and when NOT to use them',
    icon: Zap,
  ...
  },
  {
    ...
    description:
      'Handle 100,000+ items efficiently with virtualization techniques',
    icon: List,
    color: 'from-cyan-500 to-blue-500',
    bgColor: 'bg-cyan-50',
    borderColor: 'border-cyan-200',
  ...
  },
  {
    ...
    description:
      'Reduce initial bundle size with React.lazy(), Suspense, and route-based splitting',
    icon: Rocket,
  ...
  },
  {
    ...
    description:
      'Optimize event handlers and API calls with custom hooks for better UX',
    icon: Timer,
  ...
  },
  {
    ...
    description:
      'Learn when to use Context for global state vs traditional prop passing',
    icon: Globe,
  ...
  },
  {
    ...
    description:
      'Compare manual validation with React Hook Form + Yup schemas approach',
    icon: FileText,
  ...
  },
  {
    ...
    description:
      '30 practical custom hooks: useToggle, useFetch, useDebounce, useDarkMode, and more',
    icon: Puzzle,
  ...
  },
  {
    ...
    description:
      'Compound components, render props, HOCs, controlled components, and more',
    icon: Layout,
    color: 'from-rose-500 to-pink-500',
    bgColor: 'bg-rose-50',
    borderColor: 'border-rose-200',
...
const stats = [
  ...
  { label: 'Code Examples', value: '30+', icon: Code },
  { label: 'React Concepts', value: '20+', icon: BookOpen },
];
...
const features = [
  {
    ...
    description:
      'Each demo is fully interactive. Click, type, and see React concepts in action.',
    icon: Coffee,
  },
  {
    title: 'Real-World Examples',
    description:
      'Patterns and techniques you will actually use in production applications.',
    icon: TrendingUp,
  },
  {
    title: 'Code Included',
    description:
      'Every demo includes the source code so you can understand the implementation.',
    icon: Code,
  },
];
...
function DifficultyBadge({ level }) {
  ...
  return (
    <span
      className={`text-xs font-medium px-2 py-0.5 rounded-full ${colors[level]}`}
    >
      {level}
    </span>
  );
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative overflow-hidden bg-linear-to-br from-indigo-600 via-purple-600 to-pink-500 text-white">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-20 text-center">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto mb-10 leading-relaxed">
            Master React through hands-on interactive examples. Learn
            performance optimization, state management, and modern patterns used
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Reading documentation is good, but practicing is better. Each
            concept is demonstrated with interactive examples you can experiment
            with.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Click on any card to dive into interactive examples
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {demos.map((demo) => (
              ...
              >
                <div
                  className={`p-6 ${demo.bgColor} flex items-center justify-between`}
                >
                  <div
                    className={`inline-flex items-center justify-center w-12 h-12 rounded-xl bg-linear-to-br ${demo.color} text-white`}
                  >
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600">
            All the React concepts and APIs demonstrated in this app
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {[
            ...
            <div
              key={topic}
              className="bg-white rounded-xl py-4 px-4 text-center shadow-sm hover:shadow-md transition-shadow border border-gray-100"
            >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <p className="text-gray-600 ml-10">
                Click buttons, type in inputs, scroll lists. The demos are
                designed to show real behavior, not just static examples.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <p className="text-gray-600 ml-10">
                Many demos log messages to the console. Open DevTools (F12) to
                see render counts, function calls, and more.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <p className="text-gray-600 ml-10">
                Most screens show both the wrong way and the right way to do
                things. Compare them to understand why best practices matter.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <p className="text-gray-600 ml-10">
                Each demo includes code snippets showing the implementation.
                Study them and try implementing similar patterns in your
                projects.
              </p>
            </div>
          </div>
